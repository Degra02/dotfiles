...
-- Save file
keymap.set("i", "<C-S>", "<cmd>w<cr>", {silent = true, desc = "save file"})
keymap.set("n", "<C-S>", "<cmd>w<cr>", {silent = true, desc = "save file"})

-- Telescope
keymap.set("n", "<leader>ts", ":Telescope find_files <cr>")

-- Floating terminal
keymap.set("n", "<leader>tt", ":FloatermNew --name=myfloat --height=0.8 --width=0.7 --autoclose=2 zsh <cr> ")
keymap.set("n", "t", ":FloatermToggle myfloat<CR>")
keymap.set("t", "<Esc>", "<C-\\><C-n>:FloatermToggle<CR> :FloatermToggle") -- <C-\\><C-n>:q<CR>"
